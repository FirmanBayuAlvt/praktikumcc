    ...
    <main class="page bg-primary">
        <div class="hero bg-primary"
            ...
            <div class="greetings">
                ...
                <p class="mb-0">Temukan data pemerintahan lengkap Kelurahan <?php echo e(env('WEB_NAME', '___')); ?> Surabaya!
            ...
            <div class="tab-content" id="govTabContent">
                ...
                <div class="tab-pane fade show" id="gov-duties-tab-pane">
                    <div class="mb-5 border rounded-4 p-4 mt-4">
                        ...
                        <hr>
                        <div>
                            <embed type="application/pdf" src="<?php echo e(asset('files/perwali_2021.pdf')); ?>" width="100%"
                                height="1000"></embed>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projek Desa Cantik Fix\cantik-public-tus\resources\views/government.blade.php ENDPATH**/ ?>