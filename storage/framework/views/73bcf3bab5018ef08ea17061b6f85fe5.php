    ...
    <main class="page bg-primary">
        <div class="hero bg-primary"
            ...
            <div class="greetings text-center">
                ...
                <p class="mb-0">
                    Temukan data bantuan sosial lengkap Kelurahan <?php echo e(env('WEB_NAME', '___')); ?> Surabaya! Katalog bantuan
                    ...
                    if (assistanceData.length != 0) {
                        ...
                        $('.assistance_link').on('click', function() {
                            ...
                            if (assetUrl != "https://cantik-internal-tus.vercel.app/storage/") {
                                fileUrl =
                                    `<?php echo e(env('WEB_ASSET_URL_TUS')); ?>${content.file_bantuan}`;
                            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projek Desa Cantik Fix\cantik-public-tus\resources\views/assistance.blade.php ENDPATH**/ ?>